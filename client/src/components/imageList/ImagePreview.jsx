  ...
  return (
    <>
      <div className="fixed left-[50%] top-[50%] z-50 flex w-[650px] max-w-[80%] -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center rounded-[10px] bg-white p-[8px] shadow-xl md:p-[25px]">
        <img
          src={popup}
          className="h-[210px] w-full bg-[10%] object-cover pt-[30px] sm:h-[350px]"
          alt=""
        />
        <div
        ...
        <div
          onClick={() => setShowImage(false)}
          className="mt-[20px] cursor-pointer rounded-[4px] bg-orange-700 px-[40px] py-[8px] text-center text-[16px] text-white hover:opacity-75 sm:px-[60px] sm:py-[15px] md:mt-[20px]"
        >
          Close
        </div>
      </div>
